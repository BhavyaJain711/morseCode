...
/*
  CONTRIBUTORS:
    1. Bhavya Jain: Encode method(),and UI
    2. Tanmay Wani: Generating morse code tree, File handling, 
    3. Dev Parikh: Decode() method
    4. Kunal Kumar Sahoo: Basic implementation of `Binary tree` data structure and corresponding traversal algorithms
    5. Parshad Kyada: Instruction for usage
    6. Ronak Bohraiya: Documentations, makeSound() method
*/
